...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<TblMiddlewareUser> TblMiddlewareUsers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server= SANDAR\\MSSQLSERVER2012; Database=SSDLDotNetCore; User Id=sa; Password=admin123!; TrustServerCertificate = true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TblMiddlewareUser>(entity =>
        {
            entity.HasKey(e => e.UserId);

            entity.ToTable("Tbl_Middleware_User");
